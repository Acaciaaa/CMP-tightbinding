...
def generate_csv(*args):
    if args[0] == '1b':
        ...
        for iL, L in enumerate(L_list):
            ...
            if L == 29:
                df2['29'] = big_flow_list[3, ia]
            else:
                df1[f'{L}'] = big_flow_list[3, ia]
        df1.to_csv(f"/Users/ruiqi/Documents/tmp/currents/plot data/fig1b/non29.csv", index=False)
        df2.to_csv(f"/Users/ruiqi/Documents/tmp/currents/plot data/fig1b/29.csv", index=False)
