...
def current_Jr(name, category):
    ...
    def draw_h_fixed(whichsum):
        ...
        image = mpimg.imread("/Users/ruiqixu/Desktop/r.png")
...
plt.rcParams['mathtext.fontset'] = 'stix'  # stix 更接近 PRB 格式
plt.rcParams['axes.labelsize'] = 12  # 坐标轴标签大小
plt.rcParams['xtick.labelsize'] = 10  # x 轴刻度大小
plt.rcParams['ytick.labelsize'] = 10  # y 轴刻度大小
